 ...
 */
function formatDecimalSpaces(value, decimalSpaces = 2) {
 ...
 * convertToKrone(10)
 */
function convertKrone(amount, toKrone = true, kroneValue = 10.18) {
  if (toKrone) {
 ...
 * calculateTax(100)
 */
function calculateTax(amount, taxRate = 25) {
  return formatDecimalSpaces(amount + amount * (taxRate / 100));
}

module.exports = { calculateTax, convertKrone, formatDecimalSpaces, getDiscountPercentage }